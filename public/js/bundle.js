    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(hostName, "/api/v1/users/login"),
            data: {
              email: email,
              password: password
            }
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(hostName, "/api/v1/users/logout")
          });
        case 1:
          res = _context3.v;
...
// Initialize the map and set the initial view (coordinates and zoom level)
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var hostName, url, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          console.log("development");
          hostName = window.location.hostname === 'localhost' ? 'http://localhost:3000' : 'https://natours-dag.onrender.com';
          _context.p = 1;
          url = type === 'password' ? "".concat(hostName, "/api/v1/users/updateMyPassword") : "".concat(hostName, "/api/v1/users/updateMe");
          _context.n = 2;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("".concat(hostName, "/api/v1/bookings/checkout-session/").concat(tourId));
        case 1:
          session = _context.v;
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = "".concat(hostName, "/api/v1/users/forgotPassword");
          _context.n = 1;
          return (0, _axios.default)({
            method: 'POST',
            url: url,
...
var passwordReset = exports.passwordReset = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(password, passwordConfirm) {
    var token, url, res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          console.log(token);
          _context2.p = 1;
          url = "".concat(hostName, "/api/v1/users/resetPassword/").concat(token);
          _context2.n = 2;
          return (0, _axios.default)({
            method: 'POST',
            url: url,
        ...
        case 2:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(hostName));
            }, 1500);
          }
          _context2.n = 4;
          break;
...
var passwordResetForm = document.querySelector('.form--password-reset');
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _forgotPassword.passwordReset)(password, passwordConfirm);
  });
}
if (logoutBtn) {
...
if (hamburgerMenu) {
  hamburgerMenu.addEventListener('click', function (e) {
    ...
    var nav = document.querySelector('.user-view__menu');
    nav === null || nav === void 0 || nav.classList.toggle('user-view__menu--active');
